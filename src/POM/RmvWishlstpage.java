...
public class RmvWishlstpage 
{
	...
	public RmvWishlstpage(WebDriver driver) 
	{
...
public void rmvwishlist(WebDriver driver)
{
	driver.findElement(By.xpath("//span[text()='Remove from wishlist']")).click();
